...
import torch
import math
from mask_depth_diff_gaussian_rasterization import GaussianRasterizationSettings, GaussianRasterizer
...
def gaussian_separate(gaussians, percentage=85):
...
def render(viewpoint_camera, pc: GaussianModel, pipe, bg_color: torch.Tensor, d_xyz, d_rotation, d_scaling, is_6dof=False,
    ...
    mask_feature = pc.get_mask_feature
...
def render_static(viewpoint_camera, pc: GaussianModel, pipe, bg_color: torch.Tensor, d_xyz, d_rotation, d_scaling, is_6dof=False,
    ...
    mask_feature = mask_feature[within_bound_indices].squeeze()
